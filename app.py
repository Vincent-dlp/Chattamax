...
q2 = st.selectbox("Quel sport ?", ["Athletisme","Basket","Biathlon","Football","Formule 1","Hockey sur glace","Moto","Ping-pong","Rugby à 7", "Rugby à 13","Rugby à 15","Ski alpin","Ski de fond", "Tennis"])
q3 = st.selectbox("Quel bet type ?", ["Buteur","Buteur MT","Passeur","Ace","Vainqueur","Podium","Marqueur","O/U Tirs","H2H","3way","2way", "Buteur et son équipe gagne","Autre"])
